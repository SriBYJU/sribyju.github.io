...
test.describe('Scholark AI local-first browser regression', () => {
  ...
  test('Ask Scholark and adaptive-practice dialogs are keyboard-accessible smoke paths', async ({ page }) => {
    await page.goto(BASE, { waitUntil: 'domcontentloaded' });
    await waitForAI(page);
    ...
    await page.locator('#sk-ai-input').fill('Explain quadratics simply');
